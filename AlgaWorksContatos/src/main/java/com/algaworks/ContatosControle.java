...
public class ContatosControle {
	...
	static {
		LISTA_CONTATOS.add(new Contato("1", "Isabela", "+44 07788 373 223"));
		LISTA_CONTATOS.add(new Contato("2", "Elena", "+44 07788 373 223"));
		LISTA_CONTATOS.add(new Contato("3", "Romulo", "+44 07788 373 223"));
		LISTA_CONTATOS.add(new Contato("4", "Rosinella", "+44 07788 373 223"));
		LISTA_CONTATOS.add(new Contato("5", "Rafael", "+44 07788 373 223"));
	}
